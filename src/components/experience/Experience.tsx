...
const experiences = [
  {
    ...
    • Collaborated and met with clients to gather requirements, design user interfaces, and implement applications using Microsoft Power Apps and Power Automate, enhancing internal workflows and increasing efficiency.
    ...
    tools: ["Microsoft Power Platform", "User Interface Design", "Dataverse", "Data Visualization", "Requirements Gathering"],
